  ...
  return (
    ...
    <motion.span initial={{ opacity: 0 }}
        ...
        animate={{y:0,opacity:1}} transition={{
            ...
            <a className='focus:scale-110 hover:scale-[1.15] hover:bg-gray-200 active:scale-105 transition rounded-full' href='https://github.com/manojkumarjala-dev' target='_blank'><Image src={github} alt="Github" className='h-10 w-10 pt-1'></Image></a>
        </motion.div>
